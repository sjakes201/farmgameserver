...
module.exports = async function (ws, actionData) {
    ...
    let newStatus = actionData.newDescription;

    if(typeof newStatus !== 'string' || !['OPEN', 'CLOSED'].includes(newStatus)) {
    ...
    try {
        ...
        request.input(`newStatus`, sql.VarChar(16), newStatus)
        ...
        let changeQuery = await request.query(`
            ...
            UPDATE Towns SET status = @newStatus WHERE townID = @townID
        `)
